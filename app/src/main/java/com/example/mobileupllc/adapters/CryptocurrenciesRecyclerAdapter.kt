...
//    }
    ...
    class CryptocurrenciesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        //        val tvCryptocurrIcon: ImageView = itemView.findViewById(R.id.cryptocurr_icon)
        ...
        val tvCurrentPrice: TextView = itemView.findViewById(R.id.cryptocurr_current_price)
        val tvChangePercentage: TextView = itemView.findViewById(R.id.cryptocurr_change_percentage)
